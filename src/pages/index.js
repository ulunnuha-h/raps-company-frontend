...
export default function Home() {
  ...
  return (
    <>
      {/* Hero Section */}
      <main className="bg-cover lg:h-[120vh] relative bg-no-repeat lg:bg-fixed bg-secondary-700 z-10">
        <div
          className="z-10 container mx-auto h-screen flex items-center justify-center pt-16 lg:pt-0 flex-col-reverse md:flex-row relative"
          id="hero"
        >
          <section className="md:basis-1/2 md:mr-12 mx-7">
            <h1 className="text-primary-800 font-grotesk md:mb-5 text-center">
              OPEN 24 HOUR
            </h1>
            <h1 className="text-primary-50 font-grotesk md:mb-5 text-center">
              TRUSTED & FAST DROP
            </h1>
            ...
            <section className="flex justify-center my-9 lg:flex-row flex-col gap-5 lg:gap-0">
              <Link
                href="./penjualan"
                as="./penjualan"
                className="btn-secondary px-10 py-2 mr-5 w-full text-center font-bold"
              >
                Jual Diamond Lock
              </Link>
              <Link
                href="./pembelian"
                as="./pembelian"
                className="btn-primary px-10 py-2 w-full text-center font-bold"
              >
                Beli Diamond Lock
              </Link>
            </section>
      ...
      <Particles
        options={homeParticleConfig}
        init={particlesInit}
        className="z-0"
      />
      {/* Diamond Lock Section */}
      <main className="lg:p-12 p-5 relative z-10">
        <h3 className="font-grotesk text-primary-50 text-center block lg:hidden">
          Diamond Lock (DL)
        </h3>
        <div
        ...
        >
          <span className="p-6 bg-secondary-500 translate-x-12 -translate-y-12 lg:block hidden">
            <Image
              src={dl}
              className="p-6 lg:animate-pulse"
              alt="dl"
              width="300"
              height="300"
            ></Image>
          ...
          <section className="text-center">
            ...
            <h2 className="font-grotesk lg:my-7 mb-5 text-primary-500">
              Rp. {hargaJualDl.toLocaleString()}
            </h2>
            <Link
              href="./penjualan"
              as="./penjualan"
              className="btn-secondary lg:px-14 px-7 lg:py-3 py-1"
            >
              Jual
            </Link>
          </section>
          <section className="text-center">
            ...
            <h2 className="font-grotesk lg:my-7 mb-5 text-primary-500">
              Rp. {hargaBeliDl.toLocaleString()}
            </h2>
            <Link
              href="./pembelian"
              as="./pembelian"
              className="btn-primary lg:px-14 px-7 lg:py-3 py-1"
            >
              Beli
            </Link>
          </section>
          <section className="h-[260px] lg:block hidden">
            <h3 className="text-primary-50 text-center w-8 whitespace-nowrap rotate-90 font-grotesk mr-6">
              Diamond Lock
            </h3>
          </section>
        </div>
      ...
      {/* Blue Gem Lock */}
      <main className=" p-5 xl:p-12 relative z-10">
        <h3 className="font-grotesk text-primary-50 text-center block xl:hidden">
          Blue Gem Lock (BGL)
        </h3>
        <div
          style={{ backgroundImage: `url(${priceBg.src})` }}
        ...
        >
          <section className="translate-y-32 xl:block hidden">
            <h3 className="text-primary-50 text-center w-8 whitespace-nowrap -rotate-90 font-grotesk ml-6">
              Blue Gem Lock
            </h3>
          </section>
          <section className="text-center text-primary-50 font-grotesk flex flex-col xl:w-1/2">
            <h3 className="self-start mb-5 flex flex-col xl:flex-row">
              ...
              <span className="text-primary-500 relative line-through xl:ml-3">
                {" "}
                Rp {(hargaBeliDl * 100).toLocaleString()}{" "}
              </span>
            </h3>
            <h2 className="xl:self-end mb-9">
              NOW ONLY<br className="block xl:hidden"></br>{" "}
              <span className="text-primary-500">
                Rp {hargaBgl.toLocaleString()}
              </span>
            </h2>
            <section className="flex justify-center xl:justify-between items-center mb-5 xl:mb-0">
              <span className="font-grotesk text-xl hidden xl:block">
                &quot;Sama Jumlahnya, Beda Harganya&quot;
              </span>
              <Link
                href="./pembelian"
                as="./pembelian"
                className="btn-primary py-3 px-12 font-bold"
              >
                Beli
              </Link>
            </section>
          ...
          <span className="xl:p-9 p-3 bg-secondary-500 xl:-translate-x-12 xl:-translate-y-12 min-w-fit m-5 xl:my-0">
            <Image
              src={bgl}
              className="p-6 xl:animate-pulse"
              alt="bgl"
              width="300"
              height="300"
            ></Image>
      ...
      <main className=" lg:p-12 p-5 relative z-10">
        <h3 className="font-grotesk text-primary-50 text-center mb-7">
          3 Langkah mudah untuk Jual/Beli Diamond Lock
        </h3>
      ...
      {/* Testimoni Pelanggan */}
      <main className="relative z-10 lg:p-12 p-2 py-5">
        <h3 className="font-grotesk text-primary-50 text-center mb-7">
