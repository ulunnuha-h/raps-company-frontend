    ...
    <main className='container mx-auto py-16'>
      <div className='p-7 lg:p-16 bg-[#ACB8DE] flex gap-12 items-center w-fit mx-auto flex-col'>
        ...
        <section className='font-grotesk text-primary-900 text-center'>
          <h3 className='mb-5'>Kurir sedang meluncur boskuu!!!</h3>
          <span className='text-2xl'>DL mu akan terkirim dalam 30 detik. Terimakasih sudah bertransaksi di DLCheap ID</span>
        </section>
